...
<body>
   ...
   <h3> Request Management Tasks </h3>
			<ul>
		    <li> <a href="newRequests"> New Requests </a> </li>
		    <li> <a href="manageRequests"> New-High Priority Requests </a> </li>
			<li> <a href="highPriortyRequests"> High Priority Requests </a> </li>
			<li> <a href="assignedRequests"> Assigned Requests </a> </li>
	...
	<div id="main">
			...
			<table border='1px'>
				...
				<c:forEach var="req" items="${reqsList}">
				   ...
				   <td><a href="requestFullDetails/${req.id}">details</a></td>  
				   </tr>  
			   </c:forEach>  
			</table>
	</div>
